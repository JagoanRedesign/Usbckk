...
async def bulk_import(
    ...
    try:
        ...
        if len(players) > 5000:
            raise HTTPException(status_code=400, detail="Maximum 5000 players per bulk import")
        
        # Dapatkan collection untuk game
        coll = get_collection(game)
